  ...
  return (
    <div className="bg-slate-900 min-h-screen text-slate-100 p-6">
      <header className="mb-8 border-b border-slate-700 pb-4">
        <h1 className="text-3xl font-extrabold text-emerald-400 tracking-tight">Volunteer Portal</h1>
        <p className="text-slate-400">Assistance Tools & Phrasebook Generator</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-6">
          ...
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 shadow-xl">
            <h2 className="text-xl font-bold mb-4 text-white">Translation Phrasebook</h2>
            <div className="space-y-4 mb-4">
              <div>
                <label htmlFor="scenario" className="block text-sm font-medium text-slate-300 mb-1">Scenario (e.g. Lost child, Directions to Gate A)</label>
                <input 
                  id="scenario"
                  type="text" 
                  value={scenario}
              ...
              <div>
                <label htmlFor="target-language" className="block text-sm font-medium text-slate-300 mb-1">Target Language</label>
                <select 
                  id="target-language"
                  value={language} 
            ...
            {phrasebook && (
              <div className="bg-slate-900 p-4 rounded border border-slate-600">
                <p className="whitespace-pre-wrap text-emerald-100">{phrasebook}</p>
              </div>
            )}
          </div>

          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 shadow-xl text-center">
            <h2 className="text-xl font-bold mb-4 text-white">Staff Escalation</h2>
            <p className="text-slate-400 mb-4">If an issue goes beyond volunteer scope, alert operations staff immediately.</p>
            <button 
