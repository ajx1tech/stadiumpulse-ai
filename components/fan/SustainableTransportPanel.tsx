 ...
 */
export default function SustainableTransportPanel(): import('react').JSX.Element {
  ...
  return (
    <div className="bg-slate-800 rounded-xl p-6 shadow-xl border border-slate-700">
      ...
      <div className="mb-6">
        ...
        >
          Estimated distance from your location:{' '}
      ...
      <div
        className="space-y-3"
        role="list"
        aria-label="Transport options sorted by sustainability"
      >
