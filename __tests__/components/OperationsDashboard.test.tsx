...
jest.mock('recharts', () => {
  ...
  return {
    ...
    AreaChart: (props: { children?: React.ReactNode }) => <div data-testid="recharts-areachart">{props.children}</div>,
...
describe('OperationsDashboard', () => {
  it('renders without crashing', () => {
    ...
    expect(screen.getByText('Organizer Operations Command Center')).toBeInTheDocument()
  })
})
