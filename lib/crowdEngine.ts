 ...
 */
export function simulateCrowdBuildup(
  ...
  const proportion =
    1 / (1 + Math.exp(-k * (180 - minutesBeforeKickoff - (180 - x0))))
 ...
 */
export function calculateGateOverloadRisk(
 ...
 */
export function getOverloadCategory(
  score: number
...
export function prioritizeIncidents(
  incidents: Incident[],
  crowdSnapshots: CrowdManagementSnapshot[]
): Incident[] {
